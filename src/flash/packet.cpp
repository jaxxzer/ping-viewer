...
Ping360BootloaderPacket::packet_id_e Ping360BootloaderPacket::packet_get_id(packet_t packet) { return static_cast<Ping360BootloaderPacket::packet_id_e>(packet[1]); }
