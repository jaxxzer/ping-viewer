...
public:
    ...
    QByteArray applicationData() { return pic_hex_application_data; }
    QByteArray configurationData() { return pic_hex_configuration_data; }

private:
    // uint8_t pic_hex_application_data[PROGRAM_MEMORY_SIZE];
    // uint8_t pic_hex_configuration_data[CONFIGURATION_MEMORY_SIZE];
    // static const qsizetype PING360_PROGRAM_MEMORY_SIZE = 0x20400;
    static const qsizetype PING360_PROGRAM_MEMORY_SIZE = 0x10;
    static const qsizetype PING360_CONFIGURATION_MEMORY_SIZE = 24;
    QByteArray pic_hex_application_data;
    QByteArray pic_hex_configuration_data;
